...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('./ApiClient'), require('./model/InlineResponse200'), require('./model/InlineResponse2001'), require('./model/InlineResponse20010'), require('./model/InlineResponse20011'), require('./model/InlineResponse20012'), require('./model/InlineResponse20013'), require('./model/InlineResponse20014'), require('./model/InlineResponse20015'), require('./model/InlineResponse20016'), require('./model/InlineResponse20017'), require('./model/InlineResponse20018'), require('./model/InlineResponse20019'), require('./model/InlineResponse2002'), require('./model/InlineResponse2003'), require('./model/InlineResponse2003Markets'), require('./model/InlineResponse2003Probabilities'), require('./model/InlineResponse2004'), require('./model/InlineResponse2004Match'), require('./model/InlineResponse2005'), require('./model/InlineResponse2006'), require('./model/InlineResponse2007'), require('./model/InlineResponse2007Series'), require('./model/InlineResponse2008'), require('./model/InlineResponse2009'), require('./api/LeaguesApi'), require('./api/LiveMatchesApi'), require('./api/LiveSeriesApi'), require('./api/MarketsApi'), require('./api/MatchesApi'), require('./api/PlayersApi'), require('./api/SeriesApi'), require('./api/SportsApi'), require('./api/StatisticsApi'), require('./api/TeamsApi'), require('./api/TournamentsApi'));
  }
