...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RtsmunityPublicApiSdk.LeaguesApi = factory(root.RtsmunityPublicApiSdk.ApiClient, root.RtsmunityPublicApiSdk.InlineResponse2001);
  }
  ...
  var exports = function(apiClient) {
    ...
    this.getLeagues = function(sport, callback) {
      ...
      if (sport == undefined || sport == null) {
        throw "Missing the required parameter 'sport' when calling getLeagues";
      }
