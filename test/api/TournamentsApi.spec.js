...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtsmunityPublicApiSdk.TournamentsApi();
  });
  ...
  describe('TournamentsApi', function() {
    describe('getTournaments', function() {
      it('should call getTournaments successfully', function(done) {
        //uncomment below and update the code to test getTournaments
        //instance.getTournaments(pet, function(error) {
