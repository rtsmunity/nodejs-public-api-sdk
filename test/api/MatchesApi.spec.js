...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtsmunityPublicApiSdk.MatchesApi();
  });
  ...
  describe('MatchesApi', function() {
    describe('getMatchPositions', function() {
      it('should call getMatchPositions successfully', function(done) {
        //uncomment below and update the code to test getMatchPositions
        //instance.getMatchPositions(pet, function(error) {
    ...
    describe('getMatchStates', function() {
      it('should call getMatchStates successfully', function(done) {
        //uncomment below and update the code to test getMatchStates
        //instance.getMatchStates(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
