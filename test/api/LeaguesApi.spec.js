...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtsmunityPublicApiSdk.LeaguesApi();
  });
  ...
  describe('LeaguesApi', function() {
    describe('getLeagues', function() {
      it('should call getLeagues successfully', function(done) {
        //uncomment below and update the code to test getLeagues
        //instance.getLeagues(pet, function(error) {
