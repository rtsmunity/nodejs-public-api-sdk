...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RtsmunityPublicApiSdk.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new RtsmunityPublicApiSdk.InlineResponse2001();
      //expect(instance).to.be.a(RtsmunityPublicApiSdk.InlineResponse2001);
    });
    ...
    it('should have the property tournaments (base name: "tournaments")', function() {
      // uncomment below and update the code to test the property tournaments
      //var instane = new RtsmunityPublicApiSdk.InlineResponse2001();
      //expect(instance).to.be();
    });
